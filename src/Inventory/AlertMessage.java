...
/**
 *
 * Alert will create alerts for the application to prevent runtime errors
 *
 * @author Tim McHale
 *
 */
public class AlertMessage {
    /**
     * runs a case statement that tells us what kind of error
    ...
    /**
     * case statement that tells us error with product
    ...
    /**
     * window that confirms cancellation
    ...
    /**
     * asks user if they want to cancel
     *
     * @return true if user inputs true
     */
    ...
    /**
     * window that confirms if something was deleted
